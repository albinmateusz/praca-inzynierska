...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(form_class=EmailValidationOnForgotPassword,
                                                                 template_name="authentication/password-reset.html"),
         name="reset_password"),

    path('password-reset-message/',
         auth_views.PasswordResetDoneView.as_view(template_name="authentication/password-reset-message.html"),
         name="password_reset_done"),

    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(form_class=EmailSetPassword,
